...
plot_n_surface <- function(data_list,
  ...
  if (is.null(names)) names <- paste0("Surface ", seq_len(k))
  if (length(names) != k) stop("Length of names must match length(data_list).")
